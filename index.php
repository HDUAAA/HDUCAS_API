    ...
    public function CASLogin() {
        ...
        if (phpCAS::isAuthenticated()) {
            ...
            $_SESSION['user'] = $user;
          	...
          	echo "当前用户名：".$user."<br><a href='./index.php?act=logout' target='_self'>退出</a><a href='./getUserInfo.php'>资料</a>";
        }
        else {
...
if (@$_REQUEST['act'] == 'logout') {
	...
	echo "欢迎使用杭电登录态同步测试程序，点此<a href='./index.php?act=login' target='_self'>登陆</a>。";
}
